...
const { getCarritoController, postCarritoController, deleteCarritoController, postFinalizarController } = require('../Controller/carritoController')
...
routerCarrito.post("/finalizarCompra", checkAuth, postFinalizarController)
